...
const Productdetails = () => {
  ...
  return (
    ...
    {activeProd?.map((item, index)=>{
      if(item.id == id){
        return (
          <Card className='d-flex flex-row bg-light m-3' key={index}>
          ...
          <Card.Body className='bg-white' style={{width:'60%'}}>
            ...
            <div className="d-flex justify-content-between align-items-center w-25 mb-2">
              <Card.Text className='m-0 text-decoration-line-through text-secondary'>$ {item.price.toFixed(2)}</Card.Text>
